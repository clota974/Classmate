...
const screenshotImageSelector = 'img[src^="/screenshot/"], img[src^="data:image/png"], img[src^="data:image/gif"], img[src^="data:image/jpeg"]';
...
export function sanitize(html) {
    return sanitizeHtml(stripDivsFromRichTextAnswer(sanitizeHtml(convertLinksToRelative(html), Object.assign({}, sanitizeOpts, { allowedTags: ['div', 'p', 'img', 'br'] }))), sanitizeOpts);
}
